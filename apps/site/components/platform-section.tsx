...
export function PlatformSection() {
  return (
    <section className="section section-dark py-24 md:py-32">
      <div className="container grid gap-10 rounded-[40px] border border-white/10 bg-white/[0.03] px-8 py-10 md:grid-cols-[1.1fr_0.9fr] md:px-12 md:py-14">
        <div className="space-y-5">
          ...
          <p className="section-copy max-w-2xl text-white/72">
            当前安装包通过 GitHub Releases 分发。官网负责讲清产品价值、支持平台和开始使用路径。
          </p>
