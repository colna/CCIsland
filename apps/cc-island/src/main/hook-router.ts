...
import type { HookEvent, HookResponse, ApprovalRequestData, ApprovalDecision, QuestionRequestData, QuestionItem } from '@ccisland/shared';
import { IPC_CHANNELS } from '@ccisland/shared';
import { describeToolInput } from '@ccisland/shared';
